          ...
          <div className="row g-5">
            <div className="col-md-6 col-lg-4">
              <div className="bg-primary rounded p-4">
                <Link to="/">
                  <h1 className="text-white text-uppercase mb-3">STAR Resort</h1>
                </Link>
                <p className="text-white mb-0">
                !!Destination designed to provide guests with a wide range of amenities, services, and recreational activities for relaxation, leisure, and enjoyment..
                </p>
              </div>
            </div>
